...
>Now that you have a dedicated profile repository, you can now use a GitHub's markdown language (which is a watered-down version of HTML) to customize your profile.
